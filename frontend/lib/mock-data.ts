...
const mockContributionsBase: MockContributionSeed[] = [
  ...
  {
    IdContribuicaoFinanceira: 5006,
    RaUsuario: 20231234,
    TipoDoacao: "Financeira",
    Quantidade: 2140,
    Meta: 2500,
    Gastos: 260,
    Fonte: "Bazar Solidário no Pátio",
    DataContribuicao: "2025-10-10",
    comprovante: { IdComprovante: 9005, Imagem: receiptUrls[2] },
  },
  {
    IdContribuicaoFinanceira: 5007,
    RaUsuario: 20231077,
    TipoDoacao: "Financeira",
    Quantidade: 980,
    Meta: 1200,
    Gastos: 140,
    Fonte: "Venda de Doces da Turma",
    DataContribuicao: "2025-10-13",
    comprovante: { IdComprovante: 9006, Imagem: receiptUrls[1] },
  },
  {
    IdContribuicaoFinanceira: 5008,
    RaUsuario: 20231288,
    TipoDoacao: "Financeira",
    Quantidade: 1575,
    Meta: 2000,
    Gastos: 210,
    Fonte: "Feira de Empreendedorismo",
    DataContribuicao: "2025-10-18",
    comprovante: { IdComprovante: 9007, Imagem: receiptUrls[0] },
  },
  {
    IdContribuicaoFinanceira: 5009,
    RaUsuario: 20231102,
    TipoDoacao: "Financeira",
    Quantidade: 430,
    Meta: 700,
    Gastos: 60,
    Fonte: "Brechó Beneficente",
    DataContribuicao: "2025-10-20",
    comprovante: { IdComprovante: 9008, Imagem: receiptUrls[3] },
  },
  {
    IdContribuicaoFinanceira: 5010,
    RaUsuario: 20231234,
    TipoDoacao: "Financeira",
    Quantidade: 620,
    Meta: 900,
    Gastos: 75,
    Fonte: "Ação entre Amigos (Rifa)",
    DataContribuicao: "2025-10-25",
    comprovante: { IdComprovante: 9009, Imagem: receiptUrls[1] },
  },
  {
    IdContribuicaoFinanceira: 5011,
    RaUsuario: 20231077,
    TipoDoacao: "Financeira",
    Quantidade: 1340,
    Meta: 1600,
    Gastos: 190,
    Fonte: "Café Solidário na Cantina",
    DataContribuicao: "2025-11-01",
    comprovante: { IdComprovante: 9010, Imagem: receiptUrls[2] },
  },
  {
    IdContribuicaoFinanceira: 5012,
    RaUsuario: 20231288,
    TipoDoacao: "Financeira",
    Quantidade: 860,
    Meta: 1100,
    Gastos: 120,
    Fonte: "Oficina Criativa e Arrecadação",
    DataContribuicao: "2025-11-03",
    comprovante: { IdComprovante: 9011, Imagem: receiptUrls[0] },
  },
  {
    IdContribuicaoFinanceira: 5013,
    RaUsuario: 20231102,
    TipoDoacao: "Financeira",
    Quantidade: 720,
    Meta: 950,
    Gastos: 85,
    Fonte: "Venda de Livros Usados",
    DataContribuicao: "2025-11-06",
    comprovante: { IdComprovante: 9012, Imagem: receiptUrls[2] },
  },
  {
    IdContribuicaoFinanceira: 5014,
    RaUsuario: 20231234,
    TipoDoacao: "Financeira",
    Quantidade: 1800,
    Meta: 2200,
    Gastos: 230,
    Fonte: "Show de Talentos Solidário",
    DataContribuicao: "2025-11-09",
    comprovante: { IdComprovante: 9013, Imagem: receiptUrls[1] },
  },
  {
    IdContribuicaoFinanceira: 5015,
    RaUsuario: 20231288,
    TipoDoacao: "Financeira",
    Quantidade: 540,
    Meta: 800,
    Gastos: 70,
    Fonte: "Arrecadação na Feira Cultural",
    DataContribuicao: "2025-11-12",
    comprovante: { IdComprovante: 9014, Imagem: receiptUrls[3] },
  },
  {
    IdContribuicaoAlimenticia: 6006,
    RaUsuario: 20231234,
    TipoDoacao: "Alimenticia",
    Quantidade: 28,
    PesoUnidade: 2,
    Meta: 40,
    Gastos: 0,
    Fonte: "Doações do Mercado do Bairro",
    DataContribuicao: "2025-10-08",
    NomeAlimento: "Macarrão",
    PontuacaoAlimento: 3.5,
    alimentos: [{ NomeAlimento: "Macarrão", Pontuacao: 3.5, Quantidade: 28 }],
  },
  {
    IdContribuicaoAlimenticia: 6007,
    RaUsuario: 20231102,
    TipoDoacao: "Alimenticia",
    Quantidade: 18,
    PesoUnidade: 1,
    Meta: 25,
    Gastos: 0,
    Fonte: "Coleta no Condomínio",
    DataContribuicao: "2025-10-11",
    NomeAlimento: "Leite em Pó",
    PontuacaoAlimento: 6,
    alimentos: [{ NomeAlimento: "Leite em Pó", Pontuacao: 6, Quantidade: 18 }],
  },
  {
    IdContribuicaoAlimenticia: 6008,
    RaUsuario: 20231077,
    TipoDoacao: "Alimenticia",
    Quantidade: 22,
    PesoUnidade: 1,
    Meta: 30,
    Gastos: 0,
    Fonte: "Arrecadação na Igreja",
    DataContribuicao: "2025-10-14",
    NomeAlimento: "Óleo de Soja",
    PontuacaoAlimento: 5,
    alimentos: [{ NomeAlimento: "Óleo de Soja", Pontuacao: 5, Quantidade: 22 }],
  },
  {
    IdContribuicaoAlimenticia: 6009,
    RaUsuario: 20231288,
    TipoDoacao: "Alimenticia",
    Quantidade: 35,
    PesoUnidade: 1,
    Meta: 50,
    Gastos: 0,
    Fonte: "Doação de Famílias",
    DataContribuicao: "2025-10-16",
    NomeAlimento: "Fubá",
    PontuacaoAlimento: 3,
    alimentos: [{ NomeAlimento: "Fubá", Pontuacao: 3, Quantidade: 35 }],
  },
  {
    IdContribuicaoAlimenticia: 6010,
    RaUsuario: 20231234,
    TipoDoacao: "Alimenticia",
    Quantidade: 12,
    PesoUnidade: 2,
    Meta: 20,
    Gastos: 0,
    Fonte: "Campanha na Cantina",
    DataContribuicao: "2025-10-19",
    NomeAlimento: "Arroz Polido",
    PontuacaoAlimento: 4,
    alimentos: [{ NomeAlimento: "Arroz Polido", Pontuacao: 4, Quantidade: 12 }],
  },
  {
    IdContribuicaoAlimenticia: 6011,
    RaUsuario: 20231102,
    TipoDoacao: "Alimenticia",
    Quantidade: 26,
    PesoUnidade: 1,
    Meta: 35,
    Gastos: 0,
    Fonte: "Coleta no Comércio Local",
    DataContribuicao: "2025-10-22",
    NomeAlimento: "Feijão Preto",
    PontuacaoAlimento: 5.5,
    alimentos: [{ NomeAlimento: "Feijão Preto", Pontuacao: 5.5, Quantidade: 26 }],
  },
  {
    IdContribuicaoAlimenticia: 6012,
    RaUsuario: 20231077,
    TipoDoacao: "Alimenticia",
    Quantidade: 16,
    PesoUnidade: 1,
    Meta: 25,
    Gastos: 0,
    Fonte: "Doação de Professores",
    DataContribuicao: "2025-10-27",
    NomeAlimento: "Açúcar Refinado",
    PontuacaoAlimento: 4,
    alimentos: [{ NomeAlimento: "Açúcar Refinado", Pontuacao: 4, Quantidade: 16 }],
  },
  {
    IdContribuicaoAlimenticia: 6013,
    RaUsuario: 20231288,
    TipoDoacao: "Alimenticia",
    Quantidade: 20,
    PesoUnidade: 1,
    Meta: 28,
    Gastos: 0,
    Fonte: "Arrecadação na Feira",
    DataContribuicao: "2025-10-30",
    NomeAlimento: "Macarrão",
    PontuacaoAlimento: 3.5,
    alimentos: [{ NomeAlimento: "Macarrão", Pontuacao: 3.5, Quantidade: 20 }],
  },
  {
    IdContribuicaoAlimenticia: 6014,
    RaUsuario: 20231234,
    TipoDoacao: "Alimenticia",
    Quantidade: 14,
    PesoUnidade: 1,
    Meta: 22,
    Gastos: 0,
    Fonte: "Campanha no Recreio",
    DataContribuicao: "2025-11-02",
    NomeAlimento: "Leite em Pó",
    PontuacaoAlimento: 6,
    alimentos: [{ NomeAlimento: "Leite em Pó", Pontuacao: 6, Quantidade: 14 }],
  },
  {
    IdContribuicaoAlimenticia: 6015,
    RaUsuario: 20231102,
    TipoDoacao: "Alimenticia",
    Quantidade: 24,
    PesoUnidade: 1,
    Meta: 32,
    Gastos: 0,
    Fonte: "Mutirão Solidário",
    DataContribuicao: "2025-11-07",
    NomeAlimento: "Óleo de Soja",
    PontuacaoAlimento: 5,
    alimentos: [{ NomeAlimento: "Óleo de Soja", Pontuacao: 5, Quantidade: 24 }],
  },
];
...
export const overallMetrics = [
  { icon: Users, label: "Pessoas Atendidas", value: "+7800", color: "text-blue-600" }, 
